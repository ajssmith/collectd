...
If set to B<false> (the default), the plugin will wait from a message
...
system. If set to B<true>, the message may be lost if messaging system
does not have sufficient resources to transfer ownership of the message.
